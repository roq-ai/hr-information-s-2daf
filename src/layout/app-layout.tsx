...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Payroll', path: '/payrolls', entity: 'payroll', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    { name: 'Vacation', path: '/vacations', entity: 'vacation', service: AccessServiceEnum.PROJECT, icon: FiSun },
